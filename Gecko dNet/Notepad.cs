...
namespace GeckoApp
{
    public partial class NoteSheets : Form
    {
        ...
        private void CreateSheet(Sheet data)
        {
            ...
            noteData.Anchor = AnchorStyles.Bottom |
                AnchorStyles.Top |
                AnchorStyles.Right |
                AnchorStyles.Left;
        ...
        private void SheetSelection_MouseMove(object sender, MouseEventArgs e)
        {
            if(e.Button == MouseButtons.Left && SourceTab != null)
            {
                ...
                if(HoveredTabPage != null)
                {
                    ...
                    } else if(SheetSelection.TabPages.IndexOf(HoveredTabPage) >
                        SheetSelection.TabPages.IndexOf(SourceTab))
                    {
                        Cursor = Cursors.Hand;
                    } else
                        Cursor = Cursors.Default;
        ...
        {
            if(e.Button == MouseButtons.Left && SheetSelection.SelectedTab != null &&
                !SheetSelection.GetTabRect(SheetSelection.SelectedIndex).IsEmpty)
