...
namespace TCPTCPGecko
{
    ...
    public class TCPGecko
    {
        ...
        private const UInt32 packetsize = 5000, uplpacketsize = 0x5000;
        ...
        private const Byte cmd_read_file = 0x52;
        private const Byte cmd_read_directory = 0x53;
        ...
        private const Byte cmd_GET_STACK_TRACE = 0xA8;
        private const Byte cmd_GET_ENTRY_POINT_ADDRESS = 0xB1;
        ...
        #endregion Screenshot processing
